    ...
    const fetchInspections = async () => {
      try {
        ...
        const { data, error } = await supabase
          .from('inspections')
          .select('id, establishment_name, inspector, status, type, scheduled_date')
      ...
      <div className="space-y-6 p-1">
        <div className="flex flex-col space-y-2">
          ...
          <p className="text-muted-foreground">
            View inspection status and other details for each establishment. Use the filters to select a specific month and year.
          </p>
        </div>
